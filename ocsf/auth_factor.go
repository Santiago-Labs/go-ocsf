...
type AuthFactor struct {
	...
	Email             *string  `json:"email" parquet:"email,optional" ch:"email"`
	FactorType        *string  `json:"factor_type" parquet:"factor_type,optional" ch:"factor_type"`
	FactorTypeID      int32    `json:"factor_type_id" parquet:"factor_type_id" ch:"factor_type_id"`
	IsHOTP            *bool    `json:"is_hotp" parquet:"is_hotp,optional" ch:"is_hotp"`
	IsTOTP            *bool    `json:"is_totp" parquet:"is_totp,optional" ch:"is_totp"`
	PhoneNumber       *string  `json:"phone_number" parquet:"phone_number,optional" ch:"phone_number"`
	Provider          *string  `json:"provider" parquet:"provider,optional" ch:"provider"`
	SecurityQuestions []string `json:"security_questions" parquet:"security_questions,list,optional" ch:"security_questions"`
}
