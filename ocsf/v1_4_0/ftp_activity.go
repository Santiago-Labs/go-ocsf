...
type FTPActivity struct {
	...
	Codes []int32 `json:"codes,omitempty" parquet:"codes,optional,list"`
	...
	CommandResponses []string `json:"command_responses,omitempty" parquet:"command_responses,optional,list"`
