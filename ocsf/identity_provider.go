...
type IdentityProvider struct {
	AuthFactors  []*AuthFactor `json:"auth_factors,omitempty" parquet:"auth_factors,list,optional" ch:"auth_factors"`
	Domain       *string       `json:"domain,omitempty" parquet:"domain,optional" ch:"domain"`
	Fingerprint  *Fingerprint  `json:"fingerprint,omitempty" parquet:"fingerprint,optional" ch:"fingerprint"`
	HasMFA       *bool         `json:"has_mfa,omitempty" parquet:"has_mfa,optional" ch:"has_mfa"`
	Issuer       *string       `json:"issuer,omitempty" parquet:"issuer,optional" ch:"issuer"`
	...
	SCIM         *SCIM         `json:"scim,omitempty" parquet:"scim,optional" ch:"scim"`
	SSO          *SSO          `json:"sso,omitempty" parquet:"sso,optional" ch:"sso"`
	State        *string       `json:"state,omitempty" parquet:"state,optional" ch:"state"`
	StateID      *int          `json:"state_id,omitempty" parquet:"state_id,optional" ch:"state_id"`
