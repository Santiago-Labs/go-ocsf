...
type Authorization struct {
	Decision *string `json:"decision,omitempty" parquet:"decision,optional" ch:"decision,omitempty"`
	Policy   *Policy `json:"policy,omitempty" parquet:"policy,optional" ch:"policy,omitempty"`
}
