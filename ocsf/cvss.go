...
type CVSS struct {
	...
	Depth        *string   `json:"depth" parquet:"depth,optional" ch:"depth"`
	Metrics      []*Metric `json:"metrics" parquet:"metrics,list,optional" ch:"metrics"`
	OverallScore *float64  `json:"overall_score" parquet:"overall_score,optional" ch:"overall_score"`
	Severity     *string   `json:"severity" parquet:"severity,optional" ch:"severity"`
	VectorString *string   `json:"vector_string" parquet:"vector_string,optional" ch:"vector_string"`
